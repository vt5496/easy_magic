...
const Registration = (props) => {
    ...
    return (
        <div className={s.main}>
            <span>Name</span>
            <input ref={newNameRegistrationElement} onChange={readNewNameRegistrationText} value={newNameRegistrationTextValue} type="text"/>

            <span>Surname</span>
            <input ref={newSurnameRegistrationElement} onChange={readNewSurnameRegistrationText} value={newSurnameRegistrationTextValue} type="text"/>

            <span>Email</span>
            <input ref={newEmailRegistrationElement} onChange={readNewEmailRegistrationText} value={newEmailRegistrationTextValue} type="email"/>

            <span>Number</span>
            <input ref={newNumberRegistrationElement} onChange={readNewNumberRegistrationText} value={newNumberRegistrationTextValue} type="tel"/>

            <span>Img</span>
            <input ref={newImgRegistrationElement} onChange={readNewImgRegistrationText} value={newImgRegistrationTextValue} type="text"/>

            <span>Login</span>
            <input ref={newLoginRegistrationElement} onChange={readNewLoginRegistrationText} value={newLoginRegistrationTextValue} type="text"/>

            <span>Password</span>
            <input ref={newPasswordRegistrationElement} onChange={readNewPasswordRegistrationText} value={newPasswordRegistrationTextValue} type="password"/>

            <NavLink exact to='/authorization'><button onClick={registrationButton}>Sign up</button></NavLink>
        </div>
    )
}
